...
export auxbasis_hf="def2-tzvp-jkfit"
export auxbasis_mp2="def2-tzvp-ri"
export chkfile_hf="/scr/u/u3651388/osv_mp2_ml_gen/work/mywater/hf_mat.chk"
export chkfile_loc="/scr/u/u3651388/osv_mp2_ml_gen/work/mywater/loc_var.chk"
export molecule=mywater
#export moles=$OSVMP2PATH/coords/$molecule.xyz
export moles=/scr/u/u3651388/osv_mp2_ml_gen/orca2pyscf/xyz_files/mywater/mywater.xyz
