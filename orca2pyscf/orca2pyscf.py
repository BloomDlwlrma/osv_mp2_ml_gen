...
def get_M_orca(coord, basis, verbose):
    verified_basis = ["cc-pVTZ", "def2-TZVP"]
...
def save_chkhf(mf):
    ...
    chkhf = '/home/ubuntu/Shiwei/gen_feature/orca2pyscf/source_files/water/water_def2tzvp/hf_mat.chk'
...
def save_chkloc(mf):
    chkfile_loc = "/home/ubuntu/Shiwei/gen_feature/orca2pyscf/source_files/water/water_def2tzvp/loc_var.chk"
